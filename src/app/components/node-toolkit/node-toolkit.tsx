...
const steps = [
  ...
  {
    element: '.zoom-slider',
    intro: 'Zoom Slider<br><br>[Description]',
    position: 'left',
  },
  {
    element: '.brainstorm-node',
    intro: 'Brainstorm node<br><br>[Description]',
    position: 'left',
  },
  {
    element: '.flex-node',
    intro: 'Flex node<br><br>[Description]',
    position: 'left',
  },
  {
    element: '.chat-node',
    intro: 'Search node<br><br>[Description]',
    position: 'left',
  },
  {
    element: '.concept-node',
    intro: 'Concept hierarchy node<br><br>[Description]',
    position: 'left',
  },
  {
    element: '.memo-node',
    intro: 'Memo node<br><br>[Description]',
    position: 'left',
  },
  {
    element: '.minimap',
...
const NodeToolkit = (props: any) => {
  ...
  return (
    <div className="node-toolkit" data-intro='Hello step one!'>
      ...
      <div className='toolkit-option add-node' draggable onClick={startIntroJS}>
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
